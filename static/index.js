...
function onoff() {
  ...
  document.getElementsByClassName('user_link_text')[0].style.backgroundColor = '#232323'
  document.getElementsByClassName('user_link_button')[0].style.backgroundColor = '#232323'
  document.getElementsByClassName('withdrawal')[0].style.backgroundColor = '#232323'
  document.getElementsByClassName('logout_button')[0].style.backgroundColor = '#232323'
  
  document.getElementsByClassName('user_link_button')[0].style.color = '#ffffff'
